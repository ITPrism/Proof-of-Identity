...
<?php endif; ?>
    ...
    <div class="span4">
        <a href="http://itprism.com/free-joomla-extensions/ecommerce-gamification/verifying-user-profile" target="_blank"><img src="../media/com_identityproof/images/logo.png" alt="<?php echo JText::_('COM_IDENTITYPROOF'); ?>"/></a>
        ...
        <?php } ?>
        <div class="alert alert-info cf-upgrade-info"><i class="icon-info"></i> <?php echo JText::_('COM_IDENTITYPROOF_HOW_TO_UPGRADE'); ?></div>
        <div class="alert alert-info cf-upgrade-info"><i class="icon-comment"></i> <?php echo JText::_('COM_IDENTITYPROOF_FEEDBACK_INFO'); ?></div>
    </div>
</div>
